...
"""
from app.services.email.sender import dispatch, dispatch_or_raise
...
def send_certificate_email(to_email, first_name, full_name, course_name,
    ...
    dispatch_or_raise(to_email, subject, body,
...
def send_nudge(to_email, first_name, course_name, org_name='Medical Locum Jobs'):
    ...
    dispatch_or_raise(to_email, f"Reminder: {course_name}",
